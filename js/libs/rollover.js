...
Rollover.prototype = {
  ...
  setOptions: function(options) {
    this.options = {
      rolloverSuffix: 'over',
			rolloverClass: '.roller', // If you instantiate Rollover on a doc-wide element (i.e. #container) add this class attribute the <a> containing the image you want to rollover. Then, all images inside <a> tags with this class will inherit rollover behavior. This prevents issues if you have an image inside an <a> that you DON'T want to rollover.
      selectedSuffix: 'sel',
      suffixSeperator: '_'
    };
